				...
				<s2ui:form width='100%' height='200' elementId='formContainer'
					...
					<g:form action='roleSearch' name='roleSearchForm'>
						...
						<table>
							<tbody>
								<tr>
									<td><g:message code='role.authority.label'
											default='Authority' />:</td>
									<td><g:textField name='authority' class='textField'
								...
								<tr>
									<td colspan='2'><s2ui:submitButton elementId='search'
											form='roleSearchForm' messageCode='spring.security.ui.search' /></td>
								</tr>
							</tbody>
						</table>
					</g:form>
							...
							<tbody>
								<g:each in="${results}" status="i" var="role">
									<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
										<td><g:link action="edit" id="${role.id}">
